...
<div class='container'>
        ...
        <div class='col-md-4 col-sm-4 col-xs-4'>
          <div class='mode_selector'></div>
        </div><!--col-->

       <div class='col-md-4 col-sm-4 col-xs-4'> 
          <div class='outer_shutter'id='camera_shutter'>
            <div id="image_button" class="shutter_button"></div>
          </div>
          
          <div id='video_shutter' class='outer_shutter'>
            <div id="video_button" class="shutter_button"></div>
          </div>

        </div><!--col-->
        <div class='col-md-4 col-sm-4 col-xs-4'>
        <img src="img/settings.svg" alt="settings icon" class='settings_icon'>
        </div><!--col-->
        </div> <!--row-->
</div><!--container-->
      ...
      <div class="container-fluid text-center settings_div">
         <div class="panel-group" id="" <?php echo $displayStyle; ?> >
